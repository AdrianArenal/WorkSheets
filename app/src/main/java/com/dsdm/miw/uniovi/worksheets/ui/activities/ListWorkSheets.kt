...
class ListWorkSheets : AppCompatActivity() {
    ...
    private val items = listOf(
            WorkSheet("Adrian","Dario", Date(),Date(),"Descripcion",true,3.2,4.1),
            WorkSheet("Pedro","Dario", Date(),Date(),"Descripcion",true,3.2,4.1),
            WorkSheet("Manolo","Dario", Date(),Date(),"Descripcion",true,3.2,4.1),
