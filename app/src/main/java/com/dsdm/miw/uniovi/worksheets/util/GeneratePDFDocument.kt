...
class GeneratePDFDocument {
    ...
    fun createPdf(dest : String, customer : String, worker : String,
        ...
        val startDate = SimpleDateFormat("dd/MM/yyyy hh:mm",Locale.getDefault()).format(start)
        val endDate = SimpleDateFormat("dd/MM/yyyy hh:mm",Locale.getDefault()).format(end)
